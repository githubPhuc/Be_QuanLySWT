...
namespace be.Helper
{
    public static class SQLHelper
    {
        ...
        {
            var _Defines = new Defines();
            string result = _Defines.INIT_STRING;
            try
            {
        ...
        public static async Task<SqlDataReader> ExecuteReader(string connectionString, string storedProcedureName, params SqlParameter[] parameters)
        {
